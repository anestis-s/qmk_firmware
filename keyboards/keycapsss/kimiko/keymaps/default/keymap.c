...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    switch(get_highest_layer(layer_state)) {
        case _RAISE:
            rgb_matrix_set_color_all(0,40,0);
            break;
        case _LOWER:
            rgb_matrix_set_color_all(40,40,0);
            break;
        case _ADJUST:
            rgb_matrix_set_color_all(0,40,40);
            // RGB_MATRIX_INDICATOR_SET_COLOR(index, 0,40,40);
            break;
        default:
            rgb_matrix_set_color_all(40,40,40);
            rgb_matrix_set_color(1,50,0,0);
            rgb_matrix_set_color(45,0,40,0);
            break;
    }
}
