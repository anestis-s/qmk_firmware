...
[_LOWER] = LAYOUT(
    ...
    XXXXXXX, KC_EQL, XXXXXXX, XXXXXXX, KC_EXLM, KC_AT  ,                    XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX,KC_LABK, KC_RABK, KC_HASH, KC_DLR ,                    KC_EQL , KC_ASTR, KC_LBRC, KC_RBRC, KC_AMPR, XXXXXXX,
    XXXXXXX, XXXXXXX,KC_BSLS, KC_SLSH,KC_PERC, KC_CIRC, KC_CUT, KC_DLINE, KC_PLUS, KC_MINS, KC_LPRN, KC_RPRN, KC_PIPE, XXXXXXX,
